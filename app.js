...
let pvr = [
    {
        ...
        h: [1, 2, 78, 20, 20, 23, 8, 11, 18, 19, 13, 12],
        f: [5, 6, 15, 17, 18],
        e: [2, 7, 8, 17, 18],
        d: [5, 16 , 15, 23, 22],
        c: [1, 2, 11, 12, 19],
        b: [8, 5],
        a: [],
        price: [800, 800, 560, 560 ,560, 430, 430,999],
        date: 29,
        img: 'img/jawan.jpg',
...
// console.log(data);
        ...
        tic.innerHTML = `<div class="barcode">
                    ...
                    <div class="tic_details">
                        ...
                        <div class="seat_det">
                            ...
                            </div><div class="seat_cr">
                                <h6>TIME</h6>
                                <h6>11:00 <sub>pm</sub></h6>
                            </div>
                        </div>
                    </div>
        `
        ...
        `${seat_sr.toLocaleUpperCase()}${seat_no}${seat_price}${main_date}122023`);
...
// RESUME FROM LINE 191
// RESUME FROM LINE 209 1:10:30(copy paste)
// ALWAYS REMEMBER TO PUT THE CURRENT DATE BEFORE LINE 81